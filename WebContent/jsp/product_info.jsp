		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/${bp.pimage }">
					</div>
					...
					<input type="hidden" name="pid" value="${bp.pid }">
						<div><strong>${bp.pname }</strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>编号：${bp.pid }</div>
						</div>

						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${bp.shop_price }元/份</strong> 参 考 价： <del>￥${bp.market_price }元/份</del>
						</div>
